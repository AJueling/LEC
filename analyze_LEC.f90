...
! OHC
  ohc_int, ohc_int_SO30, ohc_int_SO45, ohc_int_SO55,                           &
  ohc_int_SO30_top, ohc_int_SO45_top, ohc_int_SO55_top,                        &
  ohc_int_SO30_bot, ohc_int_SO45_bot, ohc_int_SO55_bot
...
200 FORMAT (121(A,","),A)
201 FORMAT (121(E15.7,","),E15.7)
open  (2,file='output/analysis_LEC_'//(year//'.out'),form='formatted')
write (2,200)                                                                  &
! global integrals
  'rPm','rPe','rKm','rKe',                                     &
  'gPm','gPe','gKm','gKe',                                     &
