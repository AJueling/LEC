...
gPm_c1_field_shifted = vertical_integration(LEC_file_c1,nrec_cPKm,10,25,DZT)
gPm_c2_field_shifted = vertical_integration(LEC_file_c2,nrec_cPKm,10,25,DZT)
gPm_c3_field_shifted = vertical_integration(LEC_file_c3,nrec_cPKm,10,25,DZT)
gPm_c4_field_shifted = vertical_integration(LEC_file_c4,nrec_cPKm,10,25,DZT)
...
print('cPKm SO30: ', gPm_int/1e9, 'GW')
#exit()
# if( 1==2 ):
...
# cs = m.pcolormesh(x,y,gPm_c1_field_shifted,cmap='RdBu_r',vmin=-1.,vmax=1.,shading='flat')
...
# cb.set_label(label='[W/m^2]', fontsize=16)
 cb.set_label(label='log(abs([W/m^2]))', fontsize=16)
# plt.legend(fontsize=16)
 f.tight_layout()
 plt.savefig('cPKm_c1_int9_24_log.png')
...
# m = Basemap(projection='kav7',lon_0=0,resolution='c')  # global projection
 ...
 m.drawmeridians(np.arange(-180.,181.,60.),fontsize=12)
# cs = m.pcolormesh(x,y,gPm_c3_shifted-gPm_c1_shifted,vmin=-4e5,vmax=4e5,cmap='RdBu_r')#,vmin=-0.01,vmax=0.01,shading='flat')
# cs = m.pcolormesh(x,y,(gPm_c3_field_shifted - gPm_c1_field_shifted),cmap='RdBu_r',vmin=-0.5,vmax=0.5,shading='flat')
...
# plt.legend(fontsize=16)
 f.tight_layout()
 plt.savefig('cPKm_c3_c1_int9_24_log.png')
# plt.savefig('try.eps', format='eps', dpi=100)
 plt.show()
 plt.clf()
...
# m = Basemap(projection='kav7',lon_0=0,resolution='c')  # global projection
 ...
 m.drawmeridians(np.arange(-180.,181.,60.),fontsize=12)
# cs = m.pcolormesh(x,y,gPm_c3_shifted-gPm_c1_shifted,vmin=-4e5,vmax=4e5,cmap='RdBu_r')#,vmin=-0.01,vmax=0.01,shading='flat')
# cs = m.pcolormesh(x,y,(gPm_c2_field_shifted - gPm_c1_field_shifted),cmap='RdBu_r',vmin=-0.5,vmax=0.5,shading='flat')
...
# plt.legend(fontsize=16)
 f.tight_layout()
 plt.savefig('cPKm_c2_c1_int9_24_log.png')
# plt.savefig('try.eps', format='eps', dpi=100)
 plt.show()
 plt.clf()
...
# m = Basemap(projection='kav7',lon_0=0,resolution='c')  # global projection
 ...
 m.drawmeridians(np.arange(-180.,181.,60.),fontsize=12)
# cs = m.pcolormesh(x,y,gPm_c3_shifted-gPm_c1_shifted,vmin=-4e5,vmax=4e5,cmap='RdBu_r')#,vmin=-0.01,vmax=0.01,shading='flat')
# cs = m.pcolormesh(x,y,(gPm_c4_field_shifted - gPm_c1_field_shifted),cmap='RdBu_r',vmin=-0.5,vmax=0.5,shading='flat')
...
# plt.legend(fontsize=16)
 f.tight_layout()
 plt.savefig('cPKm_c4_c1_int9_24_log.png')
# plt.savefig('try.eps', format='eps', dpi=100)
 plt.show()
 plt.clf()
