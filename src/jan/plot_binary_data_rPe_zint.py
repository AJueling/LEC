...
gPm_c1_field_shifted = vertical_integration(LEC_file_c1,nrec_rPe,10,25,DZT)
gPm_c2_field_shifted = vertical_integration(LEC_file_c2,nrec_rPe,10,25,DZT)
gPm_c3_field_shifted = vertical_integration(LEC_file_c3,nrec_rPe,10,25,DZT)
gPm_c4_field_shifted = vertical_integration(LEC_file_c4,nrec_rPe,10,25,DZT)
...
print('rPe SO30: ', gPm_int/1e18, 'EJ')
#exit()
# if( 1==2 ):
...
# plt.legend(fontsize=16)
 f.tight_layout()
 plt.savefig('rPe_c1_int9_24.png')
...
# plt.legend(fontsize=16)
 f.tight_layout()
 plt.savefig('rPe_c3_c1_int9_24.png')
# plt.savefig('try.eps', format='eps', dpi=100)
 plt.show()
 plt.clf()
...
# plt.legend(fontsize=16)
 f.tight_layout()
 plt.savefig('rPe_c2_c1_int9_24.png')
# plt.savefig('try.eps', format='eps', dpi=100)
 plt.show()
 plt.clf()
...
# plt.legend(fontsize=16)
 f.tight_layout()
 plt.savefig('rPe_c4_c1_int9_24.png')
# plt.savefig('try.eps', format='eps', dpi=100)
 plt.show()
 plt.clf()
