...
gPm_field = read_binary_2D(LEC_file_c1,imt,jmt,nrec_gKe)
gPm_c1_field_shifted = shift_field(gPm_field,shift)
gPm_field = read_binary_2D(LEC_file_c2,imt,jmt,nrec_gKe)
gPm_c2_field_shifted = shift_field(gPm_field,shift)
gPm_field = read_binary_2D(LEC_file_c3,imt,jmt,nrec_gKe)
gPm_c3_field_shifted = shift_field(gPm_field,shift)
gPm_field = read_binary_2D(LEC_file_c4,imt,jmt,nrec_gKe)
...
# plt.legend(fontsize=16)
 f.tight_layout()
 plt.savefig('gKe_c1_int9_24.png')
...
# plt.legend(fontsize=16)
 f.tight_layout()
 plt.savefig('gKe_c3_c1_int9_24.png')
# plt.savefig('try.eps', format='eps', dpi=100)
 plt.show()
 plt.clf()
...
# plt.legend(fontsize=16)
 f.tight_layout()
 plt.savefig('gKe_c2_c1_int9_24.png')
# plt.savefig('try.eps', format='eps', dpi=100)
 plt.show()
 plt.clf()
...
# plt.legend(fontsize=16)
 f.tight_layout()
 plt.savefig('gKe_c4_c1_int9_24.png')
# plt.savefig('try.eps', format='eps', dpi=100)
 plt.show()
 plt.clf()
