...
gPm_c1_field_shifted = vertical_integration(LEC_file_c1,nrec_rKe,10,25,DZT)
gPm_c2_field_shifted = vertical_integration(LEC_file_c2,nrec_rKe,10,25,DZT)
gPm_c3_field_shifted = vertical_integration(LEC_file_c3,nrec_rKe,10,25,DZT)
gPm_c4_field_shifted = vertical_integration(LEC_file_c4,nrec_rKe,10,25,DZT)
...
print('rKe SO30: ', gPm_int/1e15, 'PJ')
#exit()
# if( 1==2 ):
...
# cs = m.pcolormesh(x,y,gPm_c3_shifted-gPm_c1_shifted,vmin=-4e5,vmax=4e5,cmap='RdBu_r')#,vmin=-0.01,vmax=0.01,shading='flat')
 cs = m.pcolormesh(x,y,np.log(gPm_c1_field_shifted+0.1),cmap='RdBu_r',vmin=6,vmax=13,shading='flat')
# plot_rectangle(m,-35,80,-78,-50,'orange','WGKP region')
 ...
 cb.set_label(label='log([J/m^2])', fontsize=16)
# plt.legend(fontsize=16)
 f.tight_layout()
 plt.savefig('rKe_c1_int9_24.png')
...
# m = Basemap(projection='kav7',lon_0=0,resolution='c')  # global projection
 ...
 m.drawmeridians(np.arange(-180.,181.,60.),fontsize=12)
# cs = m.pcolormesh(x,y,gPm_c3_shifted-gPm_c1_shifted,vmin=-4e5,vmax=4e5,cmap='RdBu_r')#,vmin=-0.01,vmax=0.01,shading='flat')
 cs = m.pcolormesh(x,y,(gPm_c3_field_shifted - gPm_c1_field_shifted)/1e3,cmap='RdBu_r',vmin=-10.,vmax=10.,shading='flat')
# plot_rectangle(m,-35,80,-78,-50,'orange','WGKP region')
 plot_rectangle(m,-35,80,-78,-50,'orange')
 cb = m.colorbar(cs,location='right',pad="1%",format='%.1f')#,ticks=[-.1,0,.1])
 cb.set_label(label='[kJ/m^2]', fontsize=16)
# plt.legend(fontsize=16)
 f.tight_layout()
 plt.savefig('rKe_c3_c1_int9_24.png')
# plt.savefig('try.eps', format='eps', dpi=100)
 plt.show()
 plt.clf()
...
# m = Basemap(projection='kav7',lon_0=0,resolution='c')  # global projection
 ...
 m.drawmeridians(np.arange(-180.,181.,60.),fontsize=12)
# cs = m.pcolormesh(x,y,gPm_c3_shifted-gPm_c1_shifted,vmin=-4e5,vmax=4e5,cmap='RdBu_r')#,vmin=-0.01,vmax=0.01,shading='flat')
 cs = m.pcolormesh(x,y,(gPm_c2_field_shifted - gPm_c1_field_shifted)/1e3,cmap='RdBu_r',vmin=-10.,vmax=10.,shading='flat')
# plot_rectangle(m,-35,80,-78,-50,'orange','WGKP region')
 plot_rectangle(m,-35,80,-78,-50,'orange')
 cb = m.colorbar(cs,location='right',pad="1%",format='%.1f')#,ticks=[-.1,0,.1])
 cb.set_label(label='[kJ/m^2]', fontsize=16)
# plt.legend(fontsize=16)
 f.tight_layout()
 plt.savefig('rKe_c2_c1_int9_24.png')
# plt.savefig('try.eps', format='eps', dpi=100)
 plt.show()
 plt.clf()
...
# m = Basemap(projection='kav7',lon_0=0,resolution='c')  # global projection
 ...
 m.drawmeridians(np.arange(-180.,181.,60.),fontsize=12)
# cs = m.pcolormesh(x,y,gPm_c3_shifted-gPm_c1_shifted,vmin=-4e5,vmax=4e5,cmap='RdBu_r')#,vmin=-0.01,vmax=0.01,shading='flat')
 cs = m.pcolormesh(x,y,(gPm_c4_field_shifted - gPm_c1_field_shifted)/1e3,cmap='RdBu_r',vmin=-10.,vmax=10.,shading='flat')
# plot_rectangle(m,-35,80,-78,-50,'orange','WGKP region')
 plot_rectangle(m,-35,80,-78,-50,'orange')
 cb = m.colorbar(cs,location='right',pad="1%",format='%.1f')#,ticks=[-.1,0,.1])
 cb.set_label(label='[kJ/m^2]', fontsize=16)
# plt.legend(fontsize=16)
 f.tight_layout()
 plt.savefig('rKe_c4_c1_int9_24.png')
# plt.savefig('try.eps', format='eps', dpi=100)
 plt.show()
 plt.clf()
