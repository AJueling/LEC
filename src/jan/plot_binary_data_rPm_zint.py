...
gPm_c1_field_shifted = vertical_integration(LEC_file_c1,nrec_rPm,10,25,DZT)
gPm_c2_field_shifted = vertical_integration(LEC_file_c2,nrec_rPm,10,25,DZT)
gPm_c3_field_shifted = vertical_integration(LEC_file_c3,nrec_rPm,10,25,DZT)
gPm_c4_field_shifted = vertical_integration(LEC_file_c4,nrec_rPm,10,25,DZT)
...
print('rPm SO30: ', gPm_int/1e18, 'EJ')
...
# cs = m.pcolormesh(x,y,gPm_c3_shifted-gPm_c1_shifted,vmin=-4e5,vmax=4e5,cmap='RdBu_r')#,vmin=-0.01,vmax=0.01,shading='flat')
 cs = m.pcolormesh(x,y,np.log(gPm_c1_field_shifted+0.1),cmap='RdBu_r',vmin=10,vmax=15,shading='flat')
...
# plt.legend(fontsize=16)
 f.tight_layout()
 plt.savefig('rPm_c1_int9_24.png')
...
# m = Basemap(projection='kav7',lon_0=0,resolution='c')  # global projection
 ...
 m.drawmeridians(np.arange(-180.,181.,60.),fontsize=12)
# cs = m.pcolormesh(x,y,gPm_c3_shifted-gPm_c1_shifted,vmin=-4e5,vmax=4e5,cmap='RdBu_r')#,vmin=-0.01,vmax=0.01,shading='flat')
 cs = m.pcolormesh(x,y,(gPm_c3_field_shifted - gPm_c1_field_shifted)/1e6,cmap='RdBu_r',vmin=-.8,vmax=.8,shading='flat')
# plot_rectangle(m,-35,80,-78,-50,'orange','WGKP region')
 plot_rectangle(m,-35,80,-78,-50,'orange')
 cb = m.colorbar(cs,location='right',pad="1%",format='%.1f')#,ticks=[-.1,0,.1])
 cb.set_label(label='[MJ/m^2]', fontsize=16)
# plt.legend(fontsize=16)
 f.tight_layout()
 plt.savefig('rPm_c3_c1_int9_24.png')
# plt.savefig('try.eps', format='eps', dpi=100)
 plt.show()
 plt.clf()
...
# m = Basemap(projection='kav7',lon_0=0,resolution='c')  # global projection
 ...
 m.drawmeridians(np.arange(-180.,181.,60.),fontsize=12)
# cs = m.pcolormesh(x,y,gPm_c3_shifted-gPm_c1_shifted,vmin=-4e5,vmax=4e5,cmap='RdBu_r')#,vmin=-0.01,vmax=0.01,shading='flat')
 cs = m.pcolormesh(x,y,(gPm_c2_field_shifted - gPm_c1_field_shifted)/1e6,cmap='RdBu_r',vmin=-.8,vmax=.8,shading='flat')
# plot_rectangle(m,-35,80,-78,-50,'orange','WGKP region')
 plot_rectangle(m,-35,80,-78,-50,'orange')
 cb = m.colorbar(cs,location='right',pad="1%",format='%.1f')#,ticks=[-.1,0,.1])
 cb.set_label(label='[MJ/m^2]', fontsize=16)
# plt.legend(fontsize=16)
 f.tight_layout()
 plt.savefig('rPm_c2_c1_int9_24.png')
# plt.savefig('try.eps', format='eps', dpi=100)
 plt.show()
 plt.clf()
...
# m = Basemap(projection='kav7',lon_0=0,resolution='c')  # global projection
 ...
 m.drawmeridians(np.arange(-180.,181.,60.),fontsize=12)
# cs = m.pcolormesh(x,y,gPm_c3_shifted-gPm_c1_shifted,vmin=-4e5,vmax=4e5,cmap='RdBu_r')#,vmin=-0.01,vmax=0.01,shading='flat')
 cs = m.pcolormesh(x,y,(gPm_c4_field_shifted - gPm_c1_field_shifted)/1e6,cmap='RdBu_r',vmin=-.8,vmax=.8,shading='flat')
# plot_rectangle(m,-35,80,-78,-50,'orange','WGKP region')
 plot_rectangle(m,-35,80,-78,-50,'orange')
 cb = m.colorbar(cs,location='right',pad="1%",format='%.1f')#,ticks=[-.1,0,.1])
 cb.set_label(label='[MJ/m^2]', fontsize=16)
# plt.legend(fontsize=16)
 f.tight_layout()
 plt.savefig('rPm_c4_c1_int9_24.png')
# plt.savefig('try.eps', format='eps', dpi=100)
 plt.show()
 plt.clf()
