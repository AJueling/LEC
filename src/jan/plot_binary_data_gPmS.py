...
gPm_field = read_binary_2D(LEC_file_c1,imt,jmt,nrec_gPms)
gPm_c1_field_shifted = shift_field(gPm_field,shift)
gPm_field = read_binary_2D(LEC_file_c2,imt,jmt,nrec_gPms)
gPm_c2_field_shifted = shift_field(gPm_field,shift)
gPm_field = read_binary_2D(LEC_file_c3,imt,jmt,nrec_gPms)
gPm_c3_field_shifted = shift_field(gPm_field,shift)
gPm_field = read_binary_2D(LEC_file_c4,imt,jmt,nrec_gPms)
...
print('gPmS SO30: ', gPm_int/1e9, 'GW')
#exit()
# if( 1==2 ):
...
# plt.legend(fontsize=16)
 f.tight_layout()
 plt.savefig('gPmS_c1_int9_24.png')
...
# plt.legend(fontsize=16)
 f.tight_layout()
 plt.savefig('gPmS_c3_c1_int9_24.png')
# plt.savefig('try.eps', format='eps', dpi=100)
 plt.show()
 plt.clf()
...
# plt.legend(fontsize=16)
 f.tight_layout()
 plt.savefig('gPmS_c2_c1_int9_24.png')
# plt.savefig('try.eps', format='eps', dpi=100)
 plt.show()
 plt.clf()
...
# plt.legend(fontsize=16)
 f.tight_layout()
 plt.savefig('gPmS_c4_c1_int9_24.png')
# plt.savefig('try.eps', format='eps', dpi=100)
 plt.show()
 plt.clf()
