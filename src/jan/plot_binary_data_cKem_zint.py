...
gPm_c2_field_shifted = vertical_integration(LEC_file_c2,nrec_cKem,10,25,DZT)
gPm_c3_field_shifted = vertical_integration(LEC_file_c3,nrec_cKem,10,25,DZT)
gPm_c4_field_shifted = vertical_integration(LEC_file_c4,nrec_cKem,10,25,DZT)
...
print('cKem SO30: ', gPm_int/1e9, 'GW')
#exit()
# if( 1==2 ):
...
# plt.legend(fontsize=16)
 f.tight_layout()
 plt.savefig('cKem_c1_int9_24_log.png')
...
# plt.legend(fontsize=16)
 f.tight_layout()
 plt.savefig('cKem_c3_c1_int9_24_log.png')
# plt.savefig('try.eps', format='eps', dpi=100)
 plt.show()
 plt.clf()
...
# plt.legend(fontsize=16)
 f.tight_layout()
 plt.savefig('cKem_c2_c1_int9_24_log.png')
# plt.savefig('try.eps', format='eps', dpi=100)
 plt.show()
 plt.clf()
...
# plt.legend(fontsize=16)
 f.tight_layout()
 plt.savefig('cKem_c4_c1_int9_24_log.png')
# plt.savefig('try.eps', format='eps', dpi=100)
 plt.show()
 plt.clf()
